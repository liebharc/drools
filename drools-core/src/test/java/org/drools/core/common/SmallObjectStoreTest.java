...
public class SmallObjectStoreTest {

    private final SmallObjectStore underTest;
    ...
    public SmallObjectStore getUnderTest() {
        return underTest;
    }
    ...
    public SmallObjectStoreTest(RuleBaseConfiguration ruleBaseConfiguration) {
        underTest = new SmallObjectStore();
    }
